...
import { checkAuth, checkRoleAdmin } from "../../middlewares/auth.middleware.js";
...
router.post("/", checkAuth, checkRoleAdmin, async (req, res, next) => {
    try {
...
router.put("/:id", checkAuth, checkRoleAdmin, async (req, res, next) => {
    try {
...
router.delete("/:id", checkAuth, checkRoleAdmin, async (req, res, next) => {
    try {
