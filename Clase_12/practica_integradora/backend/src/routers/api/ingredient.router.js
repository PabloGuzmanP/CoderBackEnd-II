...
export default class IngredientRouter extends BaseRouter {
    ...
    initialize() {
        ...
        this.addPostRoute("/", [ADMIN], uploader.single("file"), (req, res) => this.#ingredientController.create(req, res));
        this.addPutRoute("/:id", [ADMIN], uploader.single("file"), (req, res) => this.#ingredientController.update(req, res));
